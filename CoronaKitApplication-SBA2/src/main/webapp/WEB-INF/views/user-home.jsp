		...
		<div class="btn-group btn-group-toggle">
			<div>
				<a class="btn btn-outline-primary"
					href="${pageContext.request.contextPath}/user/show-list">Product
					List</a> <a class="btn btn-outline-secondary"
					href="${pageContext.request.contextPath}/user/show-kit">Show
					Cart</a>
			</div>
		</div>
		<div>
